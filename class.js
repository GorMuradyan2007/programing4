...
class Grass2 {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 8) {
            ...
            var newGrass = new Grass2(newX, newY);
            grass2Arr.push(newGrass);
            this.multiply = 0;
        }
    }
...
class GrassEater2 {
    ...
    mul() {
        ...
        if (newCell && this.multiply >= 14) {
            ...
            var newGr = new GrassEater2(newX, newY);
            grassEaterArr2.push(newGr);
            this.multiply = 0;
        }
    }
    ...
    die() {
        matrix[this.y][this.x] = 0
        for (var i in grassEaterArr2) {
            if (this.x == grassEaterArr2[i].x && this.y == grassEaterArr2[i].y) {
                grassEaterArr2.splice(i, 1);
                break;
            }
        }
    }
